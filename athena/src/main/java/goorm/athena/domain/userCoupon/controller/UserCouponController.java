...
public interface UserCouponController {
    ...
    @ApiResponse(responseCode = "204", description = "해당 유저가 보유한 쿠폰을 사용했습니다.")
    @PostMapping("/v4_6")
    public ResponseEntity<UserCouponIssueResponse> issueCouponWithLuaAndStockAsync8(@Parameter(hidden = true) @CheckLogin LoginUserRequest loginUserRequest,
                                                                                    @RequestBody UserCouponIssueRequest request);
    ...
    @ApiResponse(responseCode = "204", description = "해당 유저가 보유한 쿠폰을 사용했습니다.")
    @PostMapping("/v5")
    public ResponseEntity<UserCouponIssueResponse> issueCouponWithKafka(@Parameter(hidden = true) @CheckLogin LoginUserRequest loginUserRequest,
                                                                        @RequestBody UserCouponIssueRequest request);
